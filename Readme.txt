...
- Can't recollect which song to perform next? Quik Lyrix provides you with an index of your favourite songs.

- The same app works on you phone, tablet as well as your desktop. You just need to copy the Quik Lyrix folder to your device.

- The readable font size depends on how far you are from the screen. Quik Lyrix helps you to easily resize the font. Once set, it will use the same font size throughout the session.
...
2. Copy the Quik Lyrix folder to jetty/webapps on your Android device.
...
6. You will see a list of installed apps. Click on the URL pointing to Quik Lyrix.

7. Then click 'Start.html'

8. The app will start. We recommend that you add the app to your home screen by clicking 'Add to Home screen' in your browser's menu. The next time you want to launch the app, you just have to start the iJetty server and then open Quik Lyrix by clicking the icon on your homepage. An alternate way is to create a bookmark in your browser and  use it to launch Quik Lyrix after starting iJetty.

------------------------------------
How do I add more songs?
------------------------------------
Adding songs to Quik Lyrix is simple. All you need to do is:
...
6. If you have multiple songs in the same text file, as in the case of medleys, each song title should be provided as shown below... 
    *** "My Song Title" ***
Quik Lyrix looks out for the combination * " and treats these lines as song titles.
...
Have fun using Quik Lyrix. We hope that your jam session is a lot more enjoyable :)